                                ...
                                $uploadOk = 0;
                                        ...
                                        // if everything is ok, try to upload file
                                            ...
                                            if (move_uploaded_file($_FILES["media"]["tmp_name"], $file_name)) {
                                                ...
                                                $sqlinsert = "INSERT INTO stuff (member_name ,statusIn ,details,picture_name) VALUES ( '".$stuff_name."','".$status ."' , '".$details."','".$target_file. "');";
...
<div class="staffMember" >
            <form action="" method = "post" enctype = "multipart/form-data">
                ...
                <label for="" >Enter the Full name</label>                 <input class="textInput" style = "margin-left : 12%;" type="text" name = "stuff_name"><br><br>
                <label for="" >Enter the position in the Church</label>    <input  class="textInput" style = "margin-left : 4.5%;" type="text" name = "position"><br><br>
                <label for="" >Enter comments about the person</label> <br><br>   <textarea name="comment" id="" cols="30" rows="10"></textarea><br><br>
                <label for="" >Enter His/Her profil picture</label>        <input  class="textInput" type="file"  name= "media"><br><br><br><br>
                                                            ...
                                                            foreach( $query_run as $row ){
                                                               ...
                                                               ?>
                                                                ...
                                                                <tr class="table_headerInSql">
                                                                    ...
                                                                    <td> <img  alt="no image1"style = "  width: 70%;  border-radius:10%;" width ="100px" src="<?php  echo $row['picture_name'] ;?>"> </td> <br>
