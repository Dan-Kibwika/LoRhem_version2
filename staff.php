                      ...
                      if(mysqli_num_rows($query_run) >0){
                          ...
                          foreach( $query_run as $row ){
                             ...
                             ?>
                               ...
                               <td  style = " background-color:#eafaff ; font-size : 28px;"> <b> <?php  echo $row['member_name'] ?></b> </td>
                               </tr>
                        
                               <tr class="table_headerInSql">
                               <td  style = " background-color:#f4f4f4 ; font-size : 18px; "> <?php  echo $row['statusIn'] ?> </td>
                               </tr>
                               <tr class="table_headerInSql">
                               <!-- <td><img src="stuff_picture/dino.png" style= "  width :20%;  border-radius :50rem;" alt=""></td> -->
                                  <td> <img  alt="no image1"  style = "  width: 20%;  border-radius:50%;" src="<?php  echo $row['picture_name'] ;?>"> </td> <br>
                               </tr>
                               ...
                               <tr class="table_headerInSql">
                               <td  style = " background-color:#ffffff; font-size : 18px; padding:3%;">   </td>
                               </tr>
